namespace Shop.Web.Data.Repositories
{
    ...
    public class OrderRepository : GenericRepository<Order>, IOrderRepository
    {
        ...
        public async Task<IQueryable<Order>> GetOrdersAsync(string userName)
        {
            ...
            {
                return this.context.Orders  //devuelvame todas la ordenes 
                    .Include(o => o.User)
                    .Include(o => o.Items) // pero incluyame los items // select * from orders inerjoin orderdetails inerjoin products
                    .ThenInclude(i => i.Product)//incluyame los productos
            ...
            return this.context.Orders 
                ...
                .Where(o => o.User == user) // no me des todas las orders, solo las mias, de mi usuario
                .OrderByDescending(o => o.OrderDate);
        }
